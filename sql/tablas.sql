...
CREATE TABLE IF NOT EXISTS `sql10399086`.`Referido` (
  ...
  INDEX `fk_Referido_Usuario1_idx` (`Usuario_idUsuario` ASC) ,
...
CREATE TABLE IF NOT EXISTS `sql10399086`.`Mensaje` (
  ...
  INDEX `fk_Mensaje_Usuario1_idx` (`Usuario_idUsuario` ASC) ,
  INDEX `fk_Mensaje_Compra1_idx` (`Compra_codCompra` ASC) ,
